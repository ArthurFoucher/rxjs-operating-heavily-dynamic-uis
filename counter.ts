...
export class Counter {
  ...
  private viewHtml = (): string => `
    ...
    <input id="${ElementIds.InputSetTo}" style="width:71px" type="number" min=0 value="${
    this.initialSetTo
  }"/>
  ...
  <br/>
    ...
    <input id="${ElementIds.InputTickSpeed}" style="width:100px" type="number" min=0 value="${
    this.initialTickSpeed
  }"/>
...
<!-- I'm sorry for this, but I was lazy.. :) -->
    ...
    <input id="${ElementIds.InputCountDiff}" style="width:100px" type="number" min=0 value="${
    this.initialCountDiff
  }"/>
    `;
